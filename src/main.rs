...
fn main() {
    println!("Which Temperature Conversion would you like to do? /n1:Celsius to Fahrenheit /n2:Fahrenheit to Celsius /n3:Celsius to Kelvin /n4:Kelvin to Celsius");
    let mut conversion_question:String = String::new();
    std::io::stdin().read_line(&mut conversion_question).unwrap();
    ...
    if conversion_question == 1{
        ...
        println!("Temperature in Fahrenheit: {}°F", celsius_to_fahrenheit_conversion);
        ...
        println!("Temperature in Celsius: {}°C", fahrenheit_to_celsius_conversion);
